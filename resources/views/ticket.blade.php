...
<div class="box">
    ...
    <div class="ticket">
        <span class="airline">Tourly</span>
        <span class="airline airlineslip">Tourly</span>
        <span class="boarding">Boarding pass</span>
        <div class="content">
            <div>
                <div class="jfk" style="font-size: 16px; font-weight: bold">Departure Airport:</div>
                <div class="jfk" style="font-size: 15px; display: block; margin-top: 20px">{{ $passenger->booking->flight->departureAirport->englishName }}</div>
            </div>
            <div>
                <div class="sfo" style="font-size: 16px; font-weight: bold">Arrival Airport:</div>
                <div class="sfo" style="font-size: 15px; display: block; margin-top: 20px">   {{ $passenger->booking->flight->arrivalAirport->englishName }}</div>
            </div>
            <div class="sub-content">
                <span class="watermark">Tourly</span>
                <span class="name">PASSENGER NAME<br><span>{{ $passenger->fullName }}</span></span>
                <span class="flight">PASSPORT NUMBER<br><span>{{ $passenger->passport_number }}</span></span>
                <span class="gate">SEAT TYPE<br><span>{{ $passenger->seat_type }}</span></span>
                <span class="seat">AGE GROUP<br><span>{{ $passenger->age_group }}</span></span>-
        </div>
    </div>
</div>
</body>
